...
namespace MVXUnity
{
    ...
    public class MvxTextureExtractor : MvxAsyncDataProcessor
    {
        ...
        {
            return m_textureFormat == MvxTextureFormat.DEPTH_MAP && frame.StreamContainsDataLayer(Mvx2API.BasicDataLayersGuids.DEPTHMAP_TEXTURE_DATA_LAYER, false)
                || m_textureFormat == MvxTextureFormat.ASTC && frame.StreamContainsDataLayer(Mvx2API.BasicDataLayersGuids.ASTC_TEXTURE_DATA_LAYER, false)
                || m_textureFormat == MvxTextureFormat.DXT1 && frame.StreamContainsDataLayer(Mvx2API.BasicDataLayersGuids.DXT1_TEXTURE_DATA_LAYER, false)
                || m_textureFormat == MvxTextureFormat.ETC2 && frame.StreamContainsDataLayer(Mvx2API.BasicDataLayersGuids.ETC2_TEXTURE_DATA_LAYER, false)
                || m_textureFormat == MvxTextureFormat.RGB && frame.StreamContainsDataLayer(Mvx2API.BasicDataLayersGuids.RGB_TEXTURE_DATA_LAYER, false)
                || m_textureFormat == MvxTextureFormat.IR && frame.StreamContainsDataLayer(Mvx2API.BasicDataLayersGuids.IR_TEXTURE_DATA_LAYER, false)
                || m_textureFormat == MvxTextureFormat.NVX && frame.StreamContainsDataLayer(Mvx2API.BasicDataLayersGuids.NVX_TEXTURE_DATA_LAYER, false)
                || m_textureFormat == MvxTextureFormat.NV12 && frame.StreamContainsDataLayer(Mvx2API.BasicDataLayersGuids.NV12_TEXTURE_DATA_LAYER, false)
                || m_textureFormat == MvxTextureFormat.NV21 && frame.StreamContainsDataLayer(Mvx2API.BasicDataLayersGuids.NV21_TEXTURE_DATA_LAYER, false);
        }
        ...
        private bool CollectTextureDataFromFrame(Mvx2API.Frame frame)
        {
            ...
            if (m_textureFormat == MvxTextureFormat.DEPTH_MAP && frame.StreamContainsDataLayer(Mvx2API.BasicDataLayersGuids.DEPTHMAP_TEXTURE_DATA_LAYER, false))
            {
            ...
            else if (m_textureFormat == MvxTextureFormat.ASTC && frame.StreamContainsDataLayer(Mvx2API.BasicDataLayersGuids.ASTC_TEXTURE_DATA_LAYER, false))
            {
            ...
            else if (m_textureFormat == MvxTextureFormat.DXT1 && frame.StreamContainsDataLayer(Mvx2API.BasicDataLayersGuids.DXT1_TEXTURE_DATA_LAYER, false))
            {
            ...
            else if (m_textureFormat == MvxTextureFormat.ETC2 && frame.StreamContainsDataLayer(Mvx2API.BasicDataLayersGuids.ETC2_TEXTURE_DATA_LAYER, false))
            {
            ...
            else if (m_textureFormat == MvxTextureFormat.RGB && frame.StreamContainsDataLayer(Mvx2API.BasicDataLayersGuids.RGB_TEXTURE_DATA_LAYER, false))
            {
            ...
            else if (m_textureFormat == MvxTextureFormat.IR && frame.StreamContainsDataLayer(Mvx2API.BasicDataLayersGuids.IR_TEXTURE_DATA_LAYER, false))
            {
                textureFormat = TextureFormat.R8;
            ...
            else if (m_textureFormat == MvxTextureFormat.NVX && frame.StreamContainsDataLayer(Mvx2API.BasicDataLayersGuids.NVX_TEXTURE_DATA_LAYER, false))
            {
                textureFormat = TextureFormat.R8;
                Mvx2API.FrameTextureExtractor.GetTextureResolution(frame, Mvx2API.FrameTextureExtractor.TextureType.TT_NVX, out textureWidth, out textureHeight);
                textureSizeInBytes = Mvx2API.FrameTextureExtractor.GetTextureDataSizeInBytes(frame, Mvx2API.FrameTextureExtractor.TextureType.TT_NVX);
            }
            else if (m_textureFormat == MvxTextureFormat.NV12 && frame.StreamContainsDataLayer(Mvx2API.BasicDataLayersGuids.NV12_TEXTURE_DATA_LAYER, false))
            {
                textureFormat = TextureFormat.R8;
                Mvx2API.FrameTextureExtractor.GetTextureResolution(frame, Mvx2API.FrameTextureExtractor.TextureType.TT_NV12, out textureWidth, out textureHeight);
                textureSizeInBytes = Mvx2API.FrameTextureExtractor.GetTextureDataSizeInBytes(frame, Mvx2API.FrameTextureExtractor.TextureType.TT_NV12);
            }
            else if (m_textureFormat == MvxTextureFormat.NV21 && frame.StreamContainsDataLayer(Mvx2API.BasicDataLayersGuids.NV21_TEXTURE_DATA_LAYER, false))
            {
                textureFormat = TextureFormat.R8;
                Mvx2API.FrameTextureExtractor.GetTextureResolution(frame, Mvx2API.FrameTextureExtractor.TextureType.TT_NV21, out textureWidth, out textureHeight);
                textureSizeInBytes = Mvx2API.FrameTextureExtractor.GetTextureDataSizeInBytes(frame, Mvx2API.FrameTextureExtractor.TextureType.TT_NV21);
            }
            else
            {
                return false;
        ...
        private unsafe void LoadTexture(Mvx2API.Frame frame, Texture2D targetTexture, MvxTextureFormat textureFormat, ushort width, ushort height, UInt32 sizeInBytes)
        {
            switch (textureFormat)
            {
                case MvxTextureFormat.DEPTH_MAP:
                    {
                        ...
                        fixed (byte* depthMapDataPtr = depthMapData)
                            Mvx2API.FrameTextureExtractor.CopyTextureDataRaw(frame, Mvx2API.FrameTextureExtractor.TextureType.TT_DEPTH, (IntPtr)depthMapDataPtr);
                ...
                case MvxTextureFormat.IR:
                    ...
                    break;
                case MvxTextureFormat.NVX:
                    {
                        IntPtr textureData = Mvx2API.FrameTextureExtractor.GetTextureData(frame, Mvx2API.FrameTextureExtractor.TextureType.TT_NVX);
                        targetTexture.LoadRawTextureData(textureData, (Int32)sizeInBytes);
                    }
                    break;
                case MvxTextureFormat.NV12:
                    {
                        IntPtr textureData = Mvx2API.FrameTextureExtractor.GetTextureData(frame, Mvx2API.FrameTextureExtractor.TextureType.TT_NV12);
                        targetTexture.LoadRawTextureData(textureData, (Int32)sizeInBytes);
                    }
                    break;
                case MvxTextureFormat.NV21:
                    {
                        IntPtr textureData = Mvx2API.FrameTextureExtractor.GetTextureData(frame, Mvx2API.FrameTextureExtractor.TextureType.TT_NV21);
                        targetTexture.LoadRawTextureData(textureData, (Int32)sizeInBytes);
                    }
                    break;
                default:
