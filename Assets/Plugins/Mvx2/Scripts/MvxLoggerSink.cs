...
namespace MVXUnity
{
    ...
    public class MvxLoggerSink : MonoBehaviour
    {
        ...
        [SerializeField] public MVCommon.LoggerLogLevel logLevel = MVCommon.LoggerLogLevel.LLL_INFO;
        ...
        public void OnEnable()
        {
            ...
            m_logger.LogLevel = logLevel;
            m_loggerSink = new UnityLoggerSink(this);
            m_loggerSink.LogLevel = MVCommon.LoggerLogLevel.LLL_VERBOSE;
