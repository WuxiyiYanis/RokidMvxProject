...
namespace MVXUnity.ML
{
    ...
    /// </summary>
    public class MvxMLRaycastVisualizer : MonoBehaviour
    {
        [Tooltip("The reference to the class to handle results from.")]
        public MvxMLRaycastBehavior raycast = null;
        ...
        public void OnRaycastHit(MLRaycast.ResultState state, MvxMLRaycastBehavior.Mode mode, Ray ray, RaycastHit result, float confidence)
        {
