...
namespace MVXUnity.ML
{
    ...
    public class MvxMLControllerTransform : MonoBehaviour
    {
        private MvxMLControllerConnectionHandlerBehavior _controllerConnectionHandler;
...
#pragma warning restore 414
        ...
        void Start()
        {
            _controllerConnectionHandler = GetComponent<MvxMLControllerConnectionHandlerBehavior>();
