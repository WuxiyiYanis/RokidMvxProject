...
// Mvx2 Note: Taken as-is from the original MagicLeap samples package,
// changed class name and namespace to avoid maming collisions
...
namespace MVXUnity.ML
{
    ...
    /// </summary>
    //[AddComponentMenu("XR/MagicLeap/MLSceneOptimizerBehavior")]
    public class MvxMLSceneOptimizerBehavior : MonoBehaviour
    {
        /// <summary>
        ...
        /// </summary>
        public readonly float MINIMUM_NEAR_CLIP_METERS = MLDevice.MinimumNearClipDistance;
#else
        /// <summary>
        /// The minimum recommended near clip value
        /// </summary>
        public readonly float MINIMUM_NEAR_CLIP_METERS = 0.0f;
#endif
